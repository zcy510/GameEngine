...
namespace Taro {
	...
	Ref<Taro::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Ref<Taro::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Ref<Taro::Shader> ShaderLibrary::Get(const std::string& name)
	{
